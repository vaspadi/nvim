...
local function mapSymbols(status, is_symlink)
  local statusMap = {
    [" M"] = { symbol = " M", hlGroup = "ExplorerGitModified" }, -- Modified in the working directory
    ["M "] = { symbol = "M ", hlGroup = "ExplorerGitModified" }, -- modified in index
    ["MM"] = { symbol = "MM", hlGroup = "ExplorerGitModified" }, -- modified in both working tree and index
    ["A "] = { symbol = "A ", hlGroup = "ExplorerGitAdd" }, -- Added to the staging area, new file
    ["AA"] = { symbol = "AA", hlGroup = "ExplorerGitAdd" }, -- file is added in both working tree and index
    ...
    ["??"] = { symbol = "?", hlGroup = "ExplorerGitAdd" }, -- Untracked files
    ["!!"] = { symbol = "  ", hlGroup = "NonText" }, -- Ignored files
  }

  local result = statusMap[status] or { symbol = status, hlGroup = "NonText" }
...
local function fetchGitStatus(cwd, callback)
  ...
  vim.system({
    ...
    "--ignored",
    "--porcelain",
  }, { text = true, cwd = clean_cwd }, on_exit)
end
...
function M.setup()
  ...
  -- autocmd("User", {
  --   group = augroup("bufcreate"),
  --   pattern = "MiniFilesBufferCreate",
  --   callback = function(args)
  --     -- vim.notify("bufcreate")
  --     clearCache()
  --   end,
  -- })
